...
Правила очень простые - первый игрок назвает слово по заданной теме, второй игрок называет слово, первая буква которого совпадает с последней буквой слова, названного первым игроком. Далее третий игрок и т. д по очереди.
**Внимание**
печать --> т, не ь
Вот список таких *запрещённых* букв:
- Ь
- Ы
- Ъ
- Й (ну..на й есть слова но их довольно мало) 
**Правила в Discord**
Если вы хотите написать что-то в чате с игрой, добавьте // и бот не будет ругаться.
Но, если ваще сообщение состоит только из эмодзи или это цитата сообщения, // можете не добавлять.   
";
